...
fiche Application — 22 indicateurs pondérés répartis entre exposition au risque,
...
| **Où elle apparaît** | Sections **Autonomie numérique** et **Score d'autonomie numérique** sur les fiches Application · **Rapports → Autonomie numérique** · **Nouveau depuis un modèle** sur la page des enquêtes |
...
4. Évaluez vos applications, fiche par fiche ou
   [par enquête](#collecter-les-evaluations-par-enquete).

## Les indicateurs

La section **Autonomie numérique** apparaît sur chaque fiche Application,
regroupée en huit dimensions (A–H). Chaque indicateur se note de **1 à 5** selon
sa propre grille.

![La section « Autonomie numérique » sur une fiche Application](../assets/img/en/65_ext_digital_autonomy_indicators.png)
...
![Le score d'autonomie numérique calculé sur une fiche Application](../assets/img/en/64_ext_digital_autonomy_score.png)
...
Comme les scores sont stockés sur la fiche comme n'importe quel autre champ, ils
...
- **Évaluation complète (par défaut)** — les quatre lignes
  *Digital Autonomy — … (full)* sont actives, les lignes *(quick)* inactives. Les
  fiches affichent les 22 indicateurs.
- **Évaluation rapide** — activez les quatre lignes *Digital Autonomy — …
  (quick)* et désactivez les quatre lignes *(full)*. Les fiches n'affichent que
  les neuf indicateurs rapides, et le score en découle.

!!! tip "Il n'y a pas de bascule d'affichage séparée"
    Ce choix unique dans les calculs constitue tout le commutateur. La fiche
...
Les deux ciblent les fiches Application et s'ouvrent en **brouillon** dans
...
de notation 1–5 et la même aide contextuelle que sur la fiche ; l'application des
réponses réécrit les scores sur les fiches.
...
des fiches Application : qui peut modifier une application peut la noter. Le
...
La désactivation ou la désinstallation retire les deux sections du type de fiche
mais **ne touche jamais aux valeurs enregistrées sur vos fiches**. Réactivez
...
fonctionner nativement dans Turbo EA au niveau de la fiche Application — un type
