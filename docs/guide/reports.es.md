...
- **Viaje en el tiempo** — Arrastre el control deslizante de la línea de tiempo para ver el panorama tal como está en cualquier fecha. Las fichas que aún no han comenzado se ocultan. Al mirar hacia el futuro, las fichas que **se incorporan** mientras tanto aparecen con borde discontinuo y la etiqueta *PREVISTO*, mientras que las que **se retiran** permanecen en el diagrama, atenuadas y con la etiqueta *SE RETIRA*, de modo que una transformación planificada muestra tanto lo que elimina como lo que deja. El interruptor **Mostrar tarjetas que se retiran**, en la barra de herramientas, las oculta para dejar solo el estado final. La línea de tiempo está marcada con cada fecha en la que entran o salen fichas del diagrama mostrado; haga clic en una marca para llevar el control deslizante directamente a ese cambio. El control se aplica a todas las vistas y la fecha se guarda con el informe.
