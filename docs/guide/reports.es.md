...
- **Agrupar relaciones** — En un diagrama denso, cada línea trazada por separado puede ocultar la forma del paisaje. Active esta opción en el menú **Opciones de vista** para agrupar las tarjetas relacionadas en cajas y trazar una sola conexión entre dos cajas cualesquiera, etiquetada con cuántas relaciones representa. Elija qué son las cajas: **Por capa**, **Por tipo de tarjeta** (una caja por tipo, como *Aplicaciones (8)*) o **Por subtipo**. Las relaciones entre dos tarjetas de una misma caja se siguen dibujando dentro de ella, y la tarjeta centrada permanece aparte, de modo que se ve de un vistazo cómo se relaciona con cada parte del paisaje. Pase el ratón sobre una conexión para enumerar las relaciones agrupadas, o sobre una tarjeta para iluminar solo las suyas. **Crear diagrama** no está disponible mientras las relaciones están agrupadas: las cajas y las conexiones agrupadas no tienen equivalente en el inventario al que vincular una forma.
