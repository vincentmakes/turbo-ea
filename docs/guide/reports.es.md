...
- **Viaje en el tiempo** — Arrastre el control deslizante de la línea de tiempo para ver el panorama tal como está en cualquier fecha. Las fichas que aún no han comenzado se ocultan, y las retiradas para esa fecha desaparecen junto con sus relaciones. Al mirar hacia el futuro, las fichas que **se incorporan** mientras tanto aparecen con borde discontinuo y la etiqueta *PREVISTO*, y las que **se retiran** llevan la etiqueta *SE RETIRA*, de modo que una transformación planificada se lee directamente en el diagrama. Active **Mostrar tarjetas al final de su vida útil** para mantener en el lienzo las fichas retiradas. El control se aplica a todas las vistas y la fecha se guarda con el informe.
