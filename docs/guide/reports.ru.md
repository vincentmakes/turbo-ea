...
Щелчок по группе открывает панель со списком её карточек. Кнопка **Показать в инвентаре** открывает инвентарь, отфильтрованный ровно по этому срезу — включая группу *не назначено*, — так что замеченная в отчёте ошибка классификации находится в одном клике от [массового редактирования](inventory.md#mass-edit) в инвентаре. При включённых *вложенных группах* кнопка скрыта: агрегированное поддерево не сводится к одному фильтру инвентаря.
