...
- **Показать родителя / Показать потомков** — Две точечные альтернативы режиму расширения. Включите **Показать родителя** (стрелка вверх) или **Показать потомков** (стрелка вниз) на панели управления, затем нажмите на карточку, чтобы добавить на диаграмму только её родителя в иерархии или её прямых потомков. Отключение инструмента убирает показанные им карточки.
