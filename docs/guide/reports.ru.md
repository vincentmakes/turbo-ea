...
Когда связи карточки несут значение «типа» — например **тип использования** (Владелец / Пользователь / Заинтересованная сторона) у связей Организация→Приложение или **тип поддержки** у связей Приложение→Бизнес-способность — вы можете окрашивать карточки по этому значению и фильтровать по нему. Подтипы связей отображаются в группе **Подтипы связей** в списке *Окрасить по*, а также в виде отдельной строки фильтров, и появляются только тогда, когда у выбранного типа карточек действительно есть связи с такими значениями. Карточка, связанная несколькими связями с разными значениями, показывается нейтральным цветом **Несколько**.
