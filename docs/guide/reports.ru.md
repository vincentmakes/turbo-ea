...
На панели щёлкните карточку, чтобы открыть её боковую панель, или нажмите **Показать в инвентаре**, чтобы продолжить работу в [Инвентаре](inventory.md) — он откроется сгруппированным по качеству данных: выбранный диапазон развёрнут, остальные свёрнуты рядом, так что исправлять записи можно сразу. У панелей «Без связей» и «Устаревшие» кнопки **Показать в инвентаре** нет, поскольку инвентарь не умеет фильтровать ни по одному из них.
