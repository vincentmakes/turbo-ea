...
- **Карточки с истёкшим сроком эксплуатации скрыты по умолчанию** — Связанные карточки, жизненный цикл которых достиг конца эксплуатации, скрываются, чтобы граф оставался сфокусированным; включите **Показывать карточки с истёкшим сроком эксплуатации** в меню **Отображение карточки**, чтобы снова их показать. Карточка, на которой выполнено центрирование, отображается всегда, даже если её собственный срок эксплуатации истёк
