...
- **Путешествие во времени** — перетащите ползунок шкалы времени, чтобы увидеть ландшафт на любую дату. Карточки, которые ещё не начались, скрываются, а выведенные из эксплуатации к этой дате исчезают вместе со своими связями. При взгляде в будущее карточки, которые **появляются** за этот период, обводятся пунктиром и помечаются *ПЛАН*, а выводимые из эксплуатации — меткой *ВЫВОД*: запланированная трансформация читается прямо по диаграмме, а не выводится перетаскиванием туда-обратно. Включите **Показывать карточки с истёкшим сроком эксплуатации**, чтобы оставить выведенные карточки на холсте. Ползунок действует во всех представлениях, а дата сохраняется вместе с отчётом.
