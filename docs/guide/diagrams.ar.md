...
يُرسم أول اختيارين على الشكل: فحجم البطاقة محدود، والنص الذي لا يتّسع سيتجاوز حدودها. يُحفظ كل ما تحدّده، لذا فإن توسيع التحديد لاحقًا يغيّر أي اثنين يظهران دون الحاجة إلى إعادة الاختيار.

تُحفظ هذه الأسطر مع المخطط، فيرى جميع القرّاء — بمن فيهم من يفتح رابطًا منشورًا — الأشكال نفسها. أما البطاقات الفرعية الموسّعة فتحتفظ باسمها فقط: فهي أصغر من أن تتّسع لأكثر من ذلك.

يَنقل زر **إنشاء مخطط** في [تقرير التبعيات](reports.md) إعدادات عرض البطاقات الخاصة به، فيفتح المخطط المولَّد من تقرير عارضًا الأسطر نفسها التي عرضها التقرير.
