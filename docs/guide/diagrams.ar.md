...
يعرض المعرض كل مخطط كبطاقة مدمجة تتضمّن صورة مصغّرة واسمًا ومؤلفًا وعدد البطاقات التي يشير إليها. بدّل بين عرض **البطاقات** وعرض **القائمة**، ويمكنك **إنشاء** أي مخطط أو **فتحه** أو **تعديل تفاصيله** أو تنظيمه أو **حذفه**.

### العثور على المخططات

- **الشريط الجانبي للتصفية** — يحصر الشريط الأيمن المعرض في **جميع المخططات** أو **أنشأتها أنا** أو **المفضلة** لديك، ويصفّي حسب **نوع** المخطط (Data Flow / Free Draw). استخدم زر **عوامل التصفية** لطيّه؛ وعلى الشاشات الصغيرة يُفتح كلوحة منزلقة.
...
جمّع المخططات ذات الصلة في **أقسام** — وهي تسميات مشتركة على مستوى مساحة العمل. يمكن أن ينتمي المخطط إلى عدة أقسام في آنٍ واحد. في عرض البطاقات يعرض المعرض كل قسم كعنوان قابل للطي؛ وتظهر العناصر غير المعيّنة ضمن **غير مجمّع**.

- استخدم **إدارة الأقسام** في الشريط الجانبي لإنشاء الأقسام أو إعادة تسميتها أو تغيير ألوانها أو حذفها.
- استخدم **إضافة إلى الأقسام…** من قائمة المخطط لوضعه في قسم واحد أو أكثر (يمكنك إنشاء قسم جديد مباشرةً).
- يؤدي اختيار قسم في الشريط الجانبي إلى تصفية المعرض إلى ذلك القسم فقط.
