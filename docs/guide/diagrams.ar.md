...
يعرض مفتاح التفسير العائم في أسفل اليسار مقياسًا لكل قاعدة نشطة. وقواعد الحقول و**حالة الموافقة** بدائل لا طبقات: اختيار أحدهما يمسح الآخر. وبإلغاء كل القواعد تعود لوحة الرسم إلى ألوان البطاقات. ويُحفظ الاختيار مع المخطط.
