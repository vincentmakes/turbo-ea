...
![محرر المخططات مع بطاقات ملوّنة حسب الأهمية التشغيلية](../assets/img/ar/99_diagram_editor.png)
...
- تظهر البطاقات المحدّدة كشارات فوق القائمة وتبقى محدّدة أثناء تغيير المرشّح أو البحث — أزل واحدة بعلامة × الخاصة بها. وعند حصر المرشّح في نوع هرمي واحد تتحوّل القائمة إلى شجرة بمسافات بادئة.
- يحدّد **Select all shown** كل ما يتركه المرشّح الحالي على الشاشة؛ ويضيف **Insert selected** البطاقات المحدّدة في شبكة.

تفتح النافذة نفسها في وضع التحديد الفردي لـ **Change Linked Card** و**Link to Existing Card**.

تُظهر كل بطاقة على لوحة الرسم **أيقونة نوع بطاقتها** برمزًا أبيض صغيرًا في الزاوية العلوية اليسرى، بجوار لون النوع — فيُنقَل نوع البطاقة بالأيقونة واللون معًا. يطابق هذا الأيقونات المستخدمة عبر التطبيق ويحسّن الوضوح لمستخدمي عمى الألوان. تظهر الأيقونة على البطاقات المُدرَجة من الآن فصاعدًا. لإضافة أيقونات إلى بطاقات موجودة بالفعل على مخطط أقدم، انقر **Apply card-type icons** في شريط أدوات المحرّر. أما البطاقة التي لها **شعار** خاص بها فيظهر شعارها بدلًا من ذلك، مع الإبقاء على أيقونة نوع البطاقة كشارة صغيرة في الزاوية — فتدل الشكل على المنتج وعلى نوع البطاقة معًا. تظهر الشعارات عند فتح المخطط وتتحدَّث عند تغيير أحدها؛ أما البطاقة التي لا شعار لها، وكل بطاقة من نوع أوقف المسؤول الشعارات فيه، فتُرسم تمامًا كما كانت. ويوجد في القائمة نفسها خيار **شعارات البطاقات** لإيقافها إن أردت مخططًا بلا زخرفة، وهو مُفعَّل افتراضيًا.
...
تعيد القائمة المنسدلة **التلوين حسب** في شريط الأدوات تلوين البطاقات على لوحة الرسم:

- **Card colors** (افتراضي) — تستخدم كل بطاقة لون نوع بطاقتها.
- **Approval status** — يعيد التلوين حسب `approved` / `pending` / `broken`.
- **Field values** — حدّد حقل تحديد فردي تحت أي نوع بطاقة على لوحة الرسم. **يمكن لعدة أنواع بطاقات أن تحمل كل منها قاعدة واحدة في الوقت نفسه** — التطبيقات حسب الأهمية *و* مكوّنات تقنية المعلومات حسب نموذج الاستضافة. ويحتفظ النوع الذي لم تُسنِد إليه قاعدة بلونه الحالي، بما في ذلك تعبئة ضبطتها يدويًا؛ ولا يتحوّل إلى الرمادي إلا بطاقة لم تجد قاعدتها الخاصة لها قيمة. وتحديد حقل ثانٍ داخل النوع نفسه يستبدل الأول، لأن للبطاقة تعبئة واحدة.

يعرض مفتاح التفسير العائم في أسفل اليسار مقياسًا لكل قاعدة نشطة. وقواعد الحقول و**حالة الموافقة** بدائل لا طبقات: اختيار أحدهما يمسح الآخر. وبإلغاء كل القواعد تعود لوحة الرسم إلى ألوان البطاقات. ويُحفظ الاختيار مع المخطط. ويظهر مفتاح التفسير نفسه عند فتح المخطط في وضع العرض وعبر رابطه المنشور أو المضمَّن، ليعرف القراء دلالة الألوان.

![المخطط في وضع العرض مع مفتاح الألوان](../assets/img/ar/99b_diagram_viewer_legend.png)

#### العرض على البطاقة

يحدّد زر ثانٍ في شريط الأدوات، **العرض على البطاقة**، **ما تقوله كل شكل**. حدّد **نوع البطاقة** أو **النوع الفرعي** أو أي سمة من أنواع البطاقات الموجودة حاليًا على لوحة الرسم، فيكتسب كل شكل أسطر تفاصيل صغيرة تحت اسمه. وتُدرج الحقول تحت نوع البطاقة الذي تنتمي إليه، أما الحقل الذي تشترك فيه عدة أنواع منها فيُجمع تحت **مشتركة**. وهو زر منفصل عن **التلوين حسب**، حتى لا تضطر إلى تمرير إحدى القائمتين للوصول إلى الأخرى. يزيل **مسح الكل** جميع علامات الاختيار دفعةً واحدة.

يُرسم كل اختيار على الشكل، ويَكبُر الشكل **ليتّسع له**. فالبطاقة تتّسع أصلًا لسطرين، ومن ثمّ لا يتغيّر شيء حتى تحدّد سطرًا ثالثًا؛ وبعدها ترتفع كل بطاقة قليلًا مع كل اختيار وتعود إلى حجمها عند إلغاء التحديد. أما البطاقة التي غيّرت حجمها بنفسك فتحتفظ بارتفاعك: إنها تكسب أو تُعيد مساحة سطر واحد فحسب.

تُحفظ هذه الأسطر مع المخطط، فيرى جميع القرّاء — بمن فيهم من يفتح رابطًا منشورًا — الأشكال نفسها. أما البطاقات التي تُجلَب إلى لوحة الرسم عبر **التوسيع** فتحمل الأسطر نفسها التي تحملها أي بطاقة أخرى وتكبُر بالطريقة نفسها. وأما البطاقات المرصوفة داخل حاوية **Drill-Down** أو **Roll-Up** فتعرض ما يتّسع له موضعها: فتكبيرها سيدفعها فوق الصف الذي تحتها. أما شريط عنوان الحاوية نفسه فيكبُر ليتّسع لأسطره — وينزل محتواها معه — فلا يكلّف تحويلُ بطاقةٍ إلى حاوية ما كانت تقوله أبدًا.

يَنقل زر **إنشاء مخطط** في [تقرير التبعيات](reports.md) إعدادات عرض البطاقات الخاصة به، فيفتح المخطط المولَّد من تقرير عارضًا الأسطر نفسها التي اختيرت في التقرير — جميعها، بما فيها ما لم يجد التقرير نفسه مساحة لرسمه.
...
- **Inventory Changed** — تغييرات أُجريت في المخزون منذ حفظ المخطط، جاهزة للسحب مجددًا إلى لوحة الرسم. يقدّم كل صف الإجراء المناسب، ويحلّ زر «قبول الكل» كل الصفوف دفعة واحدة:
    - بطاقة **أُعيدت تسميتها** — «قبول التحديث» يعيد كتابة تسمية الخلية؛
    - بطاقة **محذوفة** أو **مؤرشفة** — «إزالتها من المخطط» يزيل الخلية (وروابطها) من لوحة الرسم؛
    - **علاقة محذوفة** — «إزالة الرابط من المخطط» يزيل الرابط القديم من لوحة الرسم؛
    - علاقة تغيّر **اتجاه تدفقها** — «قبول التحديث» يوائم رأس السهم مع المخزون.

![لوحة المزامنة في محرر المخططات](../assets/img/ar/99a_diagram_sync_drawer.png)

يتحقق Turbo EA **تلقائيًا من تغييرات المخزون في كل مرة تفتح فيها مخططًا** — تعرض شارة زرقاء على زر Sync في شريط الأدوات عدد التغييرات التي تنتظر المراجعة. لا يُطبَّق أي شيء دون تأكيدك؛ الشارة تدعوك فقط إلى فتح اللوحة الجانبية. زر «التحقق من التحديثات» في اللوحة يعيد تشغيل الفحص نفسه عند الطلب.
...
- **من يسجّلون الدخول فقط** — يتحقق الزوار من هويتهم لدى موفّر الهوية لديك، مع إمكانية التقييد بنطاقات بريد محددة. ولا يُنشأ لهم أي حساب في Turbo EA. داخل التضمين، يُفتح تسجيل الدخول في نافذة منبثقة صغيرة، ويجب تقديم Turbo EA عبر HTTPS حتى تبقى الجلسة داخل الإطار؛ ويسجّل الزوّار الدخول مرة واحدة لكل موقع يُضمَّن فيه المخطط.
...
!!! note "تسجيل الدخول داخل التضمين"
    يعرض المخطط المنشور بخيار *من يسجّلون الدخول فقط* زر **تسجيل الدخول** داخل التضمين. يفتح هذا الزر موفّر الهوية لديك في نافذة منبثقة صغيرة، ويظهر المخطط بمجرد إغلاق تلك النافذة. ثلاثة أمور قد تعترض ذلك: يجب تقديم Turbo EA عبر **HTTPS** (لا تحتفظ المتصفحات بالجلسة عبر المواقع التي يحتاجها التضمين إلا على أصل آمن)؛ ويجب أن تسمح الصفحة المضمِّنة بالنوافذ المنبثقة من إطاراتها (الإطار المعزول بدون `allow-popups` يحظر النافذة المنبثقة والرابط البديل معاً)؛ وفي Safari استخدم رابط **فتح المخطط في علامة تبويب جديدة** الذي تعرضه شاشة تسجيل الدخول. وبشكل منفصل، يرفض Chrome تحميل تضمين من عنوان شبكة خاصة (عنوان IP أو اسم مضيف داخلي) في صفحة عامة مثل Confluence Cloud — انشر المثيل على اسم مضيف HTTPS عام، أو ضمّنه من ويكي على الشبكة نفسها.
