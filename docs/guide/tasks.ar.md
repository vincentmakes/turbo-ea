...
**شرائح المصدر** — تحمل كل مهمة مصدرًا يبيّن من أين أتت. انقر على شريحة لعرض مهام ذلك المصدر فقط (انقر على عدّة شرائح لدمجها)؛ وتعرض كل شريحة عدّادًا مباشرًا. المصادر هي:
...
- **إضافة** — منسوخة من نظام تتبّع خارجي بواسطة إضافة مثبّتة
- **يدوي** — أُنشئت يدويًا، على بطاقة أو بشكل مستقل

يحمل كل صف أيضًا شارة مصدر وشريط تمييز مرمّزَين بالألوان، بحيث تُقرأ القوائم المختلطة بلمحة واحدة.
