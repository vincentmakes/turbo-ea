...
Det kort, du sætter i centrum, afgør, hvor meget du ser, så vælgeren viser for hver type de bedst forbundne kort først. En kapabilitet er som regel det mest oplysende valg, fordi det er den eneste korttype, der i ét spring når både målene over den og applikationerne under den. Vælgeren viser **alle kort i beholdningen** — bortset fra arkiverede — uanset hvilken dato tidslinjen står på: det er her, du vælger, hvad du vil se, og skyderen er skjult på dette trin, så et kort, der allerede er udfaset, eller som endnu ikke er gået i drift, kan stadig sættes i centrum. Kort, der har nået slutningen af deres levetid **pr. i dag** (ikke pr. tidslinjens dato), bærer mærket *UDFASET* med deres slutdato; kontakten **Skjul kort ved slutningen af deres levetid** ved siden af typechipsene filtrerer dem fra. Når du først har sat et kort i centrum, kan du skifte til et andet via værktøjslinjens **Centrér på**-liste: den liste er **alfabetisk**, for på det tidspunkt ved du, hvilket kort du er ude efter — de to ordner sig forskelligt med vilje.
...
- **Korttyper** — Tragtknappen viser hver korttype på diagrammet sammen med, hvor mange kort af den type der er. Fjern fluebenet ved en type for at tage dens kort, og alle relationer der rører dem, ud af visningen — nyttigt, når du vil læse, hvordan applikationer afhænger af it-komponenter, uden de kompetencer der følger med. Et mærke på knappen tæller, hvad der er skjult lige nu, en skjult type bliver stående på listen, så den kan hentes tilbage, og **Vis alle** gendanner det hele på én gang. Det centrerede kort vises altid, uanset type. Valgene huskes mellem besøg.
...
- **Saml relationer** — På et tæt diagram kan hver linje tegnet for sig skjule landskabets form. Slå dette til i menuen **Visningsindstillinger** for at samle de relaterede kort i kasser og tegne én forbindelse mellem to kasser, mærket med hvor mange relationer den står for: tallet sidder i en pille på linjen, og linjen tegnes kraftigere, jo flere relationer den bærer, så en afhængigheds vægt kan aflæses med ét blik. Vælg, hvad kasserne er: **Efter lag**, **Efter korttype** (én kasse pr. type, fx *Applikationer (8)*) eller **Efter undertype**. Relationer mellem to kort i samme kasse tegnes stadig inde i den, og det centrerede kort står fortsat for sig selv, så du med ét blik ser, hvordan det forholder sig til hver del af landskabet. Så længe relationer er samlet, sættes de fire lagbaner til side, og kasserne placeres efter, hvad de forbinder — det holder forbindelserne korte i stedet for at lade dem løbe hele diagrammets højde; **Efter lag** giver dig lagene igen. Hold musen over en forbindelse for at se de relationer, den har samlet, eller over et kort for kun at fremhæve dets egne. Kasserne kan trækkes ligesom lagbanerne, og deres kort følger med. **Opret diagram** virker også på en samlet visning, med et forbehold, der vises først — se nedenfor.
...
- **Opret diagram** — Forvandl den aktuelle visning til et nyt, redigerbart diagram i [diagrammodulet](diagrams.md). Kort, relationer og de fire arkitekturlag genskabes, og hver figur forbliver knyttet til sit inventarkort. Du bliver bedt om et navn og føres derefter direkte til det nye diagram. Tilgængelig for brugere, der kan oprette diagrammer. Fra en visning med **Saml relationer** slået til bliver hver kasse i diagrammet til en beholder med sine kort indeni — stadig knyttet til beholdningen — mens forbindelserne mellem kasser tegnes som pynt med dagens tal: de følger ikke beholdningen, kan ikke synkroniseres og markeres ikke, når relationer ændres. En dialog fortæller det, før du bliver bedt om navnet.

![Relationer samlet efter korttype](../assets/img/da/13c_dependencies_aggregate.png)
