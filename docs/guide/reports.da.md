...
- **Vis forælder / Vis underordnede** — To målrettede alternativer til udvidelsestilstand. Slå **Vis forælder** (pil op) eller **Vis underordnede** (pil ned) til i kontrolpanelet, og klik derefter på et kort for kun at tilføje dets overordnede hierarkielement eller dets direkte underordnede til diagrammet. Når værktøjet slås fra, fjernes de kort, det viste.
