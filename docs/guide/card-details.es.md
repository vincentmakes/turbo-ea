...
- **Agregar relación** — Haga clic en **+** para crear una nueva relación; el selector lista las tarjetas coincidentes en cuanto se abre (las mejores coincidencias con lo que escribe aparecen primero, y se cargan más al desplazarse). Las tarjetas ya vinculadas se ocultan de la lista, con un texto que indica cuántas son. El selector permanece abierto tras cada elección, de modo que puede añadir varias relaciones seguidas, y cada tarjeta añadida aparece como una etiqueta justo encima del cuadro de búsqueda: haga clic en la **×** de una etiqueta para deshacer esa adición. **Listo** cierra la fila
