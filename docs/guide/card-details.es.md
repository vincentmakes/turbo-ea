...
- **Agregar relación** — Haga clic en **+** para abrir el diálogo **Agregar relaciones**. Lista las tarjetas coincidentes mientras escribe (las mejores coincidencias primero, y se cargan más al desplazarse) y oculta las ya vinculadas, con un texto que indica cuántas son. Al hacer clic en una tarjeta se vincula de inmediato y aparece como una etiqueta arriba: haga clic en la **×** de una etiqueta para deshacer esa adición. El diálogo permanece abierto para añadir tantas como quiera, y el selector **Tipo de relación** de la parte superior permite cambiar de tipo sin cerrarlo. En el móvil se abre a pantalla completa
