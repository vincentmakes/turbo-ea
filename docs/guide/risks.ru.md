...
- **Карточки** — выберите одну или несколько конкретных карточек, чтобы увидеть все риски, затрагивающие *любую* из них («показать все риски, затрагивающие приложения A, B и C»). Список просматривает весь инвентарь, поэтому угадывать название не нужно.
