...
步骤表中的*组织*列可将步骤链接到组织卡片，与应用程序 / 数据对象 / IT 组件并列。与那些单值链接不同，一个步骤可以链接**多个**组织 —— 逐个选择并可单独移除。步骤链接仅供参考 —— 它记录哪些组织参与某个步骤，但不会在卡片之间创建任何关系；业务流程 ↔ 组织关系需在卡片的「关系」选项卡中单独管理。泳道名称仍是图表中的纯自由文本，与组织卡片没有关联。
