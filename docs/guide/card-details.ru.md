...
- **Где отображается** — в заголовке карточки, в списке реестра и в любом
  опубликованном веб-портале, построенном на этом типе карточек.
...
!!! note "Логотипы сторонних компаний"
    Логотипы продуктов обычно являются товарными знаками их владельцев. Вы сами
    отвечаете за то, чтобы использование загруженного логотипа было допустимо.
