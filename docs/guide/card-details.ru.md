...
ИИ-ассистент, подключённый по [MCP](../admin/mcp.md), может задать логотип и из
встроенного набора в несколько тысяч фирменных значков — просто по имени, без
передачи файла изображения.
