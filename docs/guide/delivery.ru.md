...
!!! tip
    Планируете изменение ландшафта (замену приложения, вывод системы из эксплуатации, внедрение платформы)? Инструмент [планирования перехода](transition-planning.md) создаёт представление «до/после», которое можно привязать к инициативе и зафиксировать одним шагом.
