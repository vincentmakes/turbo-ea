...
يمكن **تجميع** جدول السجل: زر *تجميع حسب* في شريط أدوات الجدول يرتب المخاطر تحت عناوين قابلة للطي حسب الحالة أو الفئة أو المستوى الأولي أو المتبقي أو المالك، مع مجموعة «غير محدد» في الأعلى — وهو أمر عملي لمراجعة السجل مجموعةً تلو الأخرى في اجتماع المراجعة.
