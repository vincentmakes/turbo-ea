...
تُجمَّع البطاقات المرتبطة **حسب نوع البطاقة**، وتُرتَّب أبجديًا داخل كل مجموعة، وتُلوَّن بلون نوع البطاقة نفسه، فتبقى مخاطرة تمس عشرات البطاقات عبر عدة أنواع مقروءة بنظرة واحدة. ويسري الترتيب واللون ذاتهما على عمود **Cards** في شبكة السجل — إذ يسرد تلميح شريحة `+N` البطاقات المتبقية تحت عناوين أنواعها.
...
- **Cards** — اختر بطاقة أو أكثر لعرض كل مخاطرة تؤثر في *أي* منها («اعرض كل المخاطر المؤثرة في التطبيقات A وB وC»). يتصفح المُنتقي المخزون كاملًا، فلا حاجة لتخمين اسم.
