...
يمكن أيضًا ترقية مخاطرة من **مخاطرة مشروع PPM**: في علامة تبويب **المخاطر** لمبادرة PPM، ينشئ إجراء **ترقية إلى سجل المخاطر** مخاطرة مشهد مباشرة من مخاطرة المشروع — إذ يُنقل العنوان والوصف والمالك، وتُحوَّل الدرجات من 1 إلى 5 إلى مفردات السجل، وتُربط بطاقة المبادرة كبطاقة متأثرة. ويتحول نص التخفيف إلى مهمة تخفيف لمرة واحدة. هذه الترقية أيضًا متكررة النتيجة (idempotent)، وتبقى مخاطرة المشروع قابلة للتحرير بالكامل في PPM — إذ يحتفظ السجلان عمدًا بدورتي حياة مستقلتين.
