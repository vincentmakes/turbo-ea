...
- **Zeitreise** — Ziehen Sie den Zeitleistenregler, um die Landschaft zu einem beliebigen Datum zu sehen. Karten, die noch nicht begonnen haben, werden ausgeblendet, und zu diesem Datum ausgemusterte Karten verschwinden samt ihren Beziehungen. Beim Blick in die Zukunft erhalten Karten, die zwischenzeitlich **hinzukommen**, einen gestrichelten Rahmen und die Kennzeichnung *GEPLANT*, ausscheidende Karten die Kennzeichnung *ENTFÄLLT* — so lässt sich eine geplante Transformation direkt am Diagramm ablesen. Aktivieren Sie **End-of-Life-Karten anzeigen**, um ausgemusterte Karten auf der Zeichenfläche zu behalten. Der Regler wirkt auf alle Ansichten, und das Datum wird mit dem Bericht gespeichert.
