...
- **Zeitreise** — Ziehen Sie den Zeitleistenregler, um die Landschaft zu einem beliebigen Datum zu sehen. Karten, die noch nicht begonnen haben, werden ausgeblendet. Beim Blick in die Zukunft erhalten Karten, die zwischenzeitlich **hinzukommen**, einen gestrichelten Rahmen und die Kennzeichnung *GEPLANT*, während **ausscheidende** Karten abgeblendet und mit *ENTFÄLLT* gekennzeichnet im Diagramm bleiben — so zeigt eine geplante Transformation, was sie entfernt und was sie belässt. Der Schalter **Ausscheidende Karten anzeigen** in der Werkzeugleiste blendet die ausscheidenden Karten aus, sodass nur der Zielzustand bleibt. Die Zeitleiste ist mit jedem Datum markiert, an dem Karten des angezeigten Diagramms hinzukommen oder ausscheiden; ein Klick auf eine Markierung springt direkt zu dieser Änderung. Der Regler wirkt auf alle Ansichten, und das Datum wird mit dem Bericht gespeichert.
