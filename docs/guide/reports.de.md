...
Welche Karte Sie ins Zentrum stellen, entscheidet, wie viel Sie sehen — die Auswahl listet deshalb je Typ die am besten vernetzten Karten zuerst. Eine Fähigkeit ist meist die aufschlussreichste Wahl: Sie ist der einzige Kartentyp, der in einem Schritt sowohl die darüberliegenden Ziele als auch die darunterliegenden Anwendungen erreicht. Die Auswahl listet **jede Karte des Bestands** — archivierte ausgenommen — unabhängig davon, auf welchem Datum die Zeitleiste steht: hier wählen Sie aus, was Sie ansehen möchten, und der Regler ist in diesem Schritt ausgeblendet. Eine bereits ausgeschiedene Karte oder eine noch nicht gestartete lässt sich also weiterhin ins Zentrum stellen. Karten, die **zum heutigen Tag** (nicht zum Datum der Zeitleiste) ihr End-of-Life erreicht haben, tragen die Markierung *AUSGESCHIEDEN* samt End-of-Life-Datum; der Schalter **End-of-Life ausblenden** neben den Typ-Chips blendet sie aus.
