...
Abra **EA Delivery** y use **Añadir → Nuevo plan de arquitectura** en una iniciativa (o cree un plan sin vincular y adjúntelo más tarde). Un plan se construye en cuatro pasos:
...
| Permiso | Concede |
|---------|---------|
| `arch_plans.view` | Ver planes de arquitectura |
| `arch_plans.manage` | Crear, editar y eliminar planes |
| `arch_plans.commit` | Confirmar un plan (crear la iniciativa, tarjetas, relaciones, borrador de ADR, estampar fechas de fin de vida) |
