...
- **Tilføj relation** — Klik på **+** for at åbne dialogen **Tilføj relationer**. Den viser matchende kort, mens du skriver (de bedste match først, flere hentes, når du ruller), og skjuler dem, der allerede er tilknyttet, med en billedtekst der viser hvor mange. Et klik på et kort tilknytter det med det samme, og det vises som en chip øverst — klik på chippens **×** for at fortryde den tilføjelse. Dialogen forbliver åben, så du kan tilføje så mange du vil, og vælgeren **Relationstype** øverst lader dig skifte type uden at lukke den. På telefon åbner den i fuld skærm
