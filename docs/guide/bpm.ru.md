...
Столбец *Организация* в таблице шагов привязывает шаги к карточкам организаций — рядом с Приложением / Объектом данных / ИТ-компонентом:

- **Шаги в дорожке** — Все шаги дорожки BPMN разделяют одну организацию: привязка, изменение или удаление организации на любом шаге применяется ко всей дорожке. Ту же привязку можно задать, выбрав дорожку в редакторе.
- **Шаги без дорожки** — Организация привязывается к отдельному шагу.

Названия дорожек остаются свободным текстом на диаграмме — привязка дорожки к карточке организации необязательна, существующие диаграммы не затрагиваются. Привязанные организации создают связь «Бизнес-процесс → Организация», видимую на обеих карточках и в отчётах о зависимостях. Чтобы задействовать несколько организаций в одном процессе, используйте по одной дорожке на организацию — именно для этого и существуют дорожки BPMN.
