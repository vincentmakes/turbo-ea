...
Утверждение, выданное по ошибке, можно отменить, не удаляя процесс. Эта возможность **по умолчанию отключена**; администратор включает её в разделе Контролируемая публикация процессов в [Настройках](../admin/settings.md).

После включения и выдачи разрешения у опубликованной версии появляется кнопка **Отозвать**. Отзыв требует письменного обоснования, после чего:
