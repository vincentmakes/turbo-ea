...
Столбец *Организация* в таблице шагов привязывает шаги к карточкам организаций — рядом с Приложением / Объектом данных / ИТ-компонентом. В отличие от этих одиночных связей, шаг можно привязать к **нескольким** организациям — выбирайте их по одной и удаляйте по отдельности. Каждая привязка аддитивно создаёт связь «Бизнес-процесс → Организация», видимую на обеих карточках и в отчётах о зависимостях. Названия дорожек остаются обычным свободным текстом из диаграммы и не связаны с карточками организаций.
