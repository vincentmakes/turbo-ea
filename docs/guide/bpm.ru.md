...
- исходное утверждение сохраняется в записи: кто и когда утвердил, по-прежнему видно;
- фиксируется, кто, когда и почему отозвал, — в истории версий и на вкладке **История** карточки;
- у процесса **не остаётся утверждённой схемы**, пока не будет подана и утверждена новая редакция;
- извлечённые шаги процесса и их связи с карточками остаются нетронутыми.

Ранее заархивированные версии автоматически не восстанавливаются. Повторная публикация более старой редакции сама по себе является утверждением: создайте на её основе новый черновик, подайте его и добейтесь утверждения.
