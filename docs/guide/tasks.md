...
**Sort** — Order by due date (most urgent first), newest first, or origin. Your choice is remembered.

**Search** — The search box filters instantly across the todo text, linked card, assigner and assignee names.

### Managing Todos

- **Quick toggle** — Click the checkbox to mark a todo as done (or reopen it)
- **Who assigned it** — On the *Assigned to me* tab each todo shows a **From:** chip naming the person who assigned it; on *Created by me* the chip names the assignee instead
