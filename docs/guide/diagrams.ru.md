...
- **Боковая панель фильтров** — левая панель сужает галерею до **Всех диаграмм**, **Созданных мной** или вашего **Избранного** и фильтрует по **типу** диаграммы (Data Flow / Free Draw).
