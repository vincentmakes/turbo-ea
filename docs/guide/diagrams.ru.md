...
Плавающая легенда в левом нижнем углу показывает по одной шкале на каждое активное правило. Правила по полям и **Статус одобрения** — альтернативы, а не слои: выбор одного очищает другое. Если снять все правила, холст вернётся к цветам карточек. Выбор сохраняется вместе с диаграммой. Та же легенда отображается и при открытии диаграммы в режиме просмотра, чтобы читатели понимали значение цветов.
