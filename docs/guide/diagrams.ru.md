...
Галерея отображает каждую диаграмму в виде компактной карточки с миниатюрой, именем, автором и числом карточек, на которые она ссылается. Переключайтесь между видами **карточек** и **списка**, а также **Создавайте**, **Открывайте**, **Изменяйте сведения**, упорядочивайте или **Удаляйте** любую диаграмму.

### Поиск диаграмм

- **Боковая панель фильтров** — левая панель сужает галерею до **Всех диаграмм**, **Созданных мной** или вашего **Избранного** и фильтрует по **типу** диаграммы (Data Flow / Free Draw). Кнопка **Фильтры** сворачивает её; на маленьких экранах она открывается как выдвижная панель.
...
Группируйте связанные диаграммы в **разделы** — общие метки уровня рабочей области. Диаграмма может одновременно принадлежать нескольким разделам. В виде карточек галерея показывает каждый раздел как сворачиваемый заголовок; неназначенные диаграммы отображаются в группе **Без группы**.

- Используйте **Управление разделами** на боковой панели, чтобы создавать, переименовывать, перекрашивать или удалять разделы.
- Используйте **Добавить в разделы…** из меню диаграммы, чтобы поместить её в один или несколько разделов (новый раздел можно создать тут же).
- Выбор раздела на боковой панели фильтрует галерею только по этому разделу.
