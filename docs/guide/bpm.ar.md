...
### ربط المؤسّسات (المسارات والخطوات)

تُسجَّل المسؤولية التنظيمية على مستوى التدفّق بطريقتين متكاملتين:

- **تعيينات المسارات** — اربط مسار BPMN ببطاقة مؤسّسة مرة واحدة، إمّا من لوحة *تعيينات المسارات* أعلى جدول الخطوات أو باختيار المسار في المصمّم. كل خطوة في المسار ترث تلك المؤسّسة تلقائيًا.
- **التجاوز لكل خطوة** — يتيح عمود *المؤسّسة* في جدول الخطوات ربط خطوة فردية بمؤسّسة مختلفة. تظهر المؤسّسة الموروثة كشريحة بإطار؛ ويظهر التجاوز الصريح كشريحة معبّأة وله الأولوية.

تبقى أسماء المسارات نصًا حرًا في المخطط — ربط المسار ببطاقة مؤسّسة اختياري. تُحسَب المؤسّسة الفعلية للخطوة دائمًا (تجاوزها الخاص إن وُجد، وإلا فربط المسار)، لذا لا يُصان أي شيء مرتين ولا يمكن أن تتناقض روابط المسارات وروابط الخطوات أبدًا. تنشئ المؤسّسات المربوطة علاقة «عملية أعمال ← مؤسّسة» مرئية على كلتا البطاقتين وفي تقارير التبعيات.
