...
**تخطيط الأعمدة:** يتضمّن شريط الأدوات أداة **اختيار الأعمدة** — عمود واحد أو عمودان أو ثلاثة — لتوسيع بطاقات العمليات أو إظهار قدر أكبر من الصف على الشاشة. ولا يُمدّ أي صف على عدد من الأعمدة يفوق عدد عملياته، ويُحفظ الاختيار بين الزيارات.
...
- **استخراج العناصر** — عند حفظ مخطط، يستخرج النظام تلقائيًا جميع المهام والأحداث والبوابات والمسارات لأغراض التحليل. تُدرج العناصر المستخرجة وفق **ترتيب سير العملية** — متتبعةً تدفقات التسلسل والرسائل في المخطط بدءًا من حدث البداية — لا مجمّعةً حسب نوع العنصر. وتبقى خطوات الحلقة مجتمعةً، ويُدرج محتوى العملية الفرعية أسفلها مباشرةً
