...
يمكن التراجع عن اعتماد مُنح بالخطأ دون حذف العملية. هذه الميزة **معطّلة افتراضيًا**؛ ويفعّلها المسؤول من نشر العمليات الخاضع للرقابة في [الإعدادات](../admin/settings.md).

بعد التفعيل ومنح الصلاحية، يظهر على الإصدار المنشور زر **سحب**. يتطلب السحب سببًا مكتوبًا، ثم:

- تنتقل المراجعة إلى **مسحوبة** — فلا تُحذف أبدًا ولا تُعاد إلى حالة المسودة؛
- يبقى الاعتماد الأصلي مسجَّلًا: مَن اعتمده ومتى يظلان ظاهرين؛
- يُسجَّل مَن سحبه ومتى ولماذا — في سجل الإصدارات وفي تبويب **السجل** الخاص بالبطاقة؛
- تبقى العملية **بلا مخطط معتمد** إلى أن تُقدَّم مراجعة جديدة وتُعتمد؛
- تبقى خطوات العملية المستخرجة وروابطها بالبطاقات دون تغيير.

لا تُستعاد الإصدارات المؤرشفة تلقائيًا. فإعادة نشر مراجعة أقدم هي في ذاتها اعتماد: أنشئ منها مسودة جديدة، وقدِّمها، واحصل على اعتمادها.
