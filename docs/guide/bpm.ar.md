...
- تعرض **لوحة الخصائص** مجموعة **العملية المرتبطة** على كل خطوة، مع **اختر عملية…** و**فتح** (للتعمّق في تدفّق العملية المرتبطة) و**مسح**
- تحمل **قائمة السياق** للخطوة المحدَّدة مدخل **ربط عملية**، لحالة طيّ اللوحة
...
![العملية المرتبطة](../assets/img/ar/92_bpm_called_process.png)
