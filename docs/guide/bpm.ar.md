...
يربط عمود *المؤسّسة* في جدول الخطوات الخطوات ببطاقات المؤسّسات، إلى جانب التطبيق / كائن البيانات / المكوّن التقني:

- **الخطوات داخل مسار** — تتشارك جميع خطوات مسار BPMN مؤسّسة واحدة: ربط المؤسّسة أو تغييرها أو إزالتها على أي خطوة ينطبق على المسار بأكمله. ويمكن أيضًا ضبط الربط نفسه باختيار المسار في المصمّم.
- **الخطوات بدون مسار** — تُربَط المؤسّسة بالخطوة الفردية.

تبقى أسماء المسارات نصًا حرًا في المخطط — ربط المسار ببطاقة مؤسّسة اختياري، ولا تتأثر المخططات الموجودة. تنشئ المؤسّسات المربوطة علاقة «عملية أعمال ← مؤسّسة» مرئية على كلتا البطاقتين وفي تقارير التبعيات. لإشراك عدة مؤسّسات في عملية واحدة، استخدم مسارًا لكل مؤسّسة — فهذا هو الغرض من مسارات BPMN تحديدًا.
