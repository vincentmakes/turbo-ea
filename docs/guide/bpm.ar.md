...
يربط عمود *المؤسّسة* في جدول الخطوات الخطوات ببطاقات المؤسّسات، إلى جانب التطبيق / كائن البيانات / المكوّن التقني. وخلافًا لتلك الروابط أحادية القيمة، يمكن ربط الخطوة الواحدة بعدة **مؤسّسات** — اخترها واحدة تلو الأخرى وأزلها كلًّا على حدة. ينشئ كل ربط بشكل تراكمي علاقة «عملية أعمال ← مؤسّسة» مرئية على كلتا البطاقتين وفي تقارير التبعيات. تبقى أسماء المسارات نصًا حرًا خالصًا من المخطط وغير مرتبطة ببطاقات المؤسّسات.
