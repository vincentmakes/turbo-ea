...
**Чипы происхождения** — каждая задача несёт метку происхождения: откуда она появилась. Нажмите на чип, чтобы показать только задачи этого происхождения (нажмите несколько, чтобы объединить их); каждый чип показывает счётчик в реальном времени. Варианты происхождения:
...
- **Расширение** — зеркалируется из внешнего трекера установленным расширением
- **Вручную** — создана вручную, на карточке или самостоятельно

Каждая строка также несёт цветной значок происхождения и акцентную полосу, поэтому смешанные списки читаются с первого взгляда.
