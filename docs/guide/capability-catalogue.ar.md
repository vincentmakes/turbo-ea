...
يأتي Turbo EA مزوّدًا بـ **[كتالوج قدرات الأعمال المرجعي](https://catalog.turbo-ea.org)** — وهو كتالوج مفتوح ومنسَّق لقدرات الأعمال تتم صيانته على [github.com/TurboEA/turbo-ea-capabilities](https://github.com/TurboEA/turbo-ea-capabilities). تتيح لك صفحة كتالوج القدرات تصفّح هذا المرجع وإنشاء بطاقات `BusinessCapability` المطابقة بالجملة، بدلًا من كتابتها واحدة تلو الأخرى.
