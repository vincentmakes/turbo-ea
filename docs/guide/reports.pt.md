...
- **Mostrar rótulos de relação** — O verbo de cada relação (*apoia*, *usa*, …) é desenhado na sua linha. Ativado por padrão; desative no menu **Exibição de cards** para uma tela mais limpa em um panorama denso. As linhas e suas pontas de seta continuam mostrando o que se conecta a quê, e em que direção.
