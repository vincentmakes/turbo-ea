...
- **Viagem no tempo** — Arraste o controle deslizante da linha do tempo para ver o panorama tal como está em qualquer data. Os cards que ainda não começaram ficam ocultos. Olhando para o futuro, os cards que **entram** nesse intervalo aparecem com borda tracejada e o rótulo *PREVISTO*, enquanto os que **saem** permanecem no diagrama, esmaecidos e com o rótulo *A SAIR* — assim uma transformação planejada mostra tanto o que remove quanto o que deixa. A chave **Mostrar cards que saem**, na barra de ferramentas, oculta-os para deixar apenas o estado final. A linha do tempo é marcada com cada data em que os cards do diagrama exibido entram ou saem; clique em uma marca para levar o controle deslizante direto para essa mudança. O controle se aplica a todas as vistas e a data é salva com o relatório.
