...
Расширение также может объявить собственные типы уведомлений — например **Уведомления автоматизаций**, — которые появляются здесь отдельными строками (в приложении включено, по почте выключено по умолчанию), чтобы настраивать их отдельно от общей строки **Уведомление расширения**. Если расширение отключено или его лицензия истекла, его строки исчезают до возвращения; ваш выбор сохраняется. Некоторые уведомления расширений при клике открывают свои **подробности** в приложении вместо перехода на страницу: полное сообщение и кнопки для открытия связанной карточки или страницы расширения, если у вас есть право.