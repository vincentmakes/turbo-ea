...
- **Barra lateral de filtros** — el panel izquierdo limita la galería a **Todos los diagramas**, **Creados por mí** o sus **Favoritos**, y filtra por **tipo** de diagrama (Data Flow / Free Draw). Use el botón **Filtros** para contraerla; en pantallas pequeñas se abre como un panel deslizante.
