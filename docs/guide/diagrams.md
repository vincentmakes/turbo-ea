...
- **Filter sidebar** — the left rail narrows the gallery to **All diagrams**, **Created by me**, or your **Favorites**. Use the **Filters** button to collapse it; on small screens it opens as a slide-in panel.
