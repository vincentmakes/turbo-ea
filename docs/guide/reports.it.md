...
- **Viaggio nel tempo** — Trascinate il cursore della linea temporale per vedere il panorama così com'è a una data qualsiasi. Le schede non ancora avviate vengono nascoste. Guardando al futuro, le schede che **arrivano** nel frattempo hanno un bordo tratteggiato e l'etichetta *PREVISTO*, mentre quelle **in uscita** restano sul diagramma, attenuate e con l'etichetta *IN USCITA*: una trasformazione pianificata mostra così sia ciò che rimuove sia ciò che lascia. L'interruttore **Mostra le schede in uscita**, nella barra degli strumenti, le nasconde lasciando solo lo stato finale. La linea temporale è segnata con ogni data in cui le schede del diagramma visualizzato entrano o escono; cliccate su un segno per portare il cursore direttamente su quel cambiamento. Il cursore si applica a tutte le viste e la data viene salvata con il report.
