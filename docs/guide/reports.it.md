...
- **Raggruppa le relazioni** — In un diagramma affollato, ogni linea tracciata singolarmente può nascondere la forma del panorama. Attiva questa opzione nel menu **Opzioni di visualizzazione** per raggruppare le schede collegate in riquadri e tracciare una sola connessione fra due riquadri, etichettata con quante relazioni rappresenta. Scegli cosa sono i riquadri: **Per livello**, **Per tipo di scheda** (un riquadro per tipo, come *Applicazioni (8)*) o **Per sottotipo**. Le relazioni fra due schede dello stesso riquadro restano disegnate al suo interno, e la scheda al centro resta a sé: così si vede a colpo d'occhio come si rapporta a ciascuna parte del panorama. Passa sopra una connessione per elencare le relazioni raggruppate, o sopra una scheda per illuminare solo le sue. **Crea diagramma** non è disponibile mentre le relazioni sono raggruppate: riquadri e connessioni raggruppate non hanno un corrispettivo nell'inventario a cui collegare una forma.
