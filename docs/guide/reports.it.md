...
- **Viaggio nel tempo** — Trascinate il cursore della linea temporale per vedere il panorama così com'è a una data qualsiasi. Le schede non ancora avviate vengono nascoste e quelle dismesse entro quella data scompaiono insieme alle loro relazioni. Guardando al futuro, le schede che **arrivano** nel frattempo hanno un bordo tratteggiato e l'etichetta *PREVISTO*, mentre quelle che **escono** portano l'etichetta *IN USCITA*: una trasformazione pianificata si legge così direttamente dal diagramma. Attivate **Mostra schede a fine vita** per mantenere sulla tela le schede dismesse. Il cursore si applica a tutte le viste e la data viene salvata con il report.
