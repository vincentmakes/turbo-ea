...
- **Накопленные расходы по категориям** — накопленные CapEx и OpEx за выбранный финансовый год с пунктирными горизонтальными линиями, отмечающими бюджет CapEx и OpEx этого года. Переключатель **Оба / CapEx / OpEx** позволяет сосредоточиться на одной категории
...
Выбор финансового года применяется к первым двум диаграммам и предлагает текущий год, любой другой год с данными, а также **Все финансовые годы**. Выбранные категория, финансовый год и свёрнутое или развёрнутое состояние сохраняются между визитами.
