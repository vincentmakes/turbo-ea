...
من اللوحة، انقر على أي بطاقة لفتح لوحة تفاصيلها، أو اضغط **عرض في المخزون** للمتابعة في [المخزون](inventory.md) — الذي يُفتح مُجمَّعًا حسب جودة البيانات مع توسيع النطاق الذي نقرته وطيّ البقية بجانبه، لتبدأ تصحيح السجلات فورًا. لوحتا «يتيمة» و«قديمة» بلا زر **عرض في المخزون**، لأن المخزون لا يستطيع التصفية بأيٍّ منهما.
