...
- **السفر عبر الزمن** — اسحب شريط الخط الزمني لعرض المشهد كما هو في أي تاريخ. تُخفى البطاقات التي لم تبدأ بعد، وتختفي البطاقات المتوقّفة بحلول ذلك التاريخ مع علاقاتها. وعند النظر إلى المستقبل، تظهر البطاقات التي **تُضاف** خلال تلك الفترة بإطار متقطّع ووسم *مخطط*، وتحمل البطاقات التي **تتوقّف** وسم *قيد الإيقاف* — بحيث يمكن قراءة التحوّل المخطّط له مباشرةً من الرسم البياني. فعِّل **إظهار البطاقات المنتهية الصلاحية** للإبقاء على البطاقات المتوقّفة في المساحة. ينطبق الشريط على جميع طرق العرض، ويُحفظ التاريخ مع التقرير.
