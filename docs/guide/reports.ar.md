...
يؤدي النقر على مجموعة إلى فتح لوحة تعرض بطاقات تلك المجموعة. يفتح زر **عرض في المخزون** المخزونَ مصفّى على هذه الشريحة بالضبط — بما في ذلك مجموعة *غير مُسند* — بحيث يصبح الخطأ في التصنيف الذي لاحظته في التقرير على بُعد نقرة واحدة من [التحرير الجماعي](inventory.md#mass-edit) في المخزون. يُخفى الزر عند تفعيل *المجموعات المتداخلة*: فالشجرة الفرعية المجمّعة لا تقابل عامل تصفية واحدًا في المخزون.
...
- **إظهار البطاقات المنتهية الصلاحية** — تُخفى البطاقات المرتبطة التي وصلت دورة حياتها إلى نهاية العمر افتراضيًا للحفاظ على تركيز الرسم البياني؛ فعِّل هذا الزر (في قائمة **عرض البطاقة**) لإظهارها مجددًا. وتُعرض دائمًا البطاقة التي يتم التركيز عليها، حتى لو كانت هي نفسها منتهية الصلاحية.
