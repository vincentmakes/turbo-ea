...
- **قائمة عرض البطاقة** — فعِّل تسمية **النوع** و**نقطة حالة دورة الحياة**، وفعِّل **علامات التسلسل الهرمي** (سهم صغير على كل بطاقة لها عنصر أصل في الأعلى أو فروع في الأسفل غير معروضة على المخطط — تلميح لاستخدام أدوات الإظهار)، واختر **حقول سمات إضافية** لعرضها على كل بطاقة — يظهر الأولان على البطاقة وتظهر المجموعة الكاملة في تلميح التمرير. تُحفظ الاختيارات بين الزيارات. ويتوفّر **النوع الفرعي** كمفتاح مستقل. وكل ما تختاره هنا ينتقل مع **إنشاء مخطط**: فالمخطط المولَّد من هذا التقرير يُفتح عارضًا الأسطر نفسها.
