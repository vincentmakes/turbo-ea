...
- **العرض على البطاقة** — زر مخصص في شريط الأدوات (رمز العين) يعرض على هيئة **مربعات اختيار** كل ما يمكن أن تعرضه البطاقة: تسمية **النوع**، و**النوع الفرعي**، و**نقطة حالة دورة الحياة**، وكل **حقل سمة** متاح، مصنّفًا تحت نوع البطاقة الذي ينتمي إليه. يظهر أول سطرين على البطاقة نفسها، وتظهر المجموعة الكاملة في التلميح. تُظهر شارة على الزر عدد الأسطر المعروضة حاليًا. تُحفظ الاختيارات بين الزيارات وتنتقل مع **إنشاء مخطط**: يفتح مخطط DrawIO المُنشأ من هذا التقرير بالأسطر نفسها، مختارةً من القائمة نفسها — وجميعها هناك، لأن شكل المخطط يكبر ليتّسع لها بينما عقدة التقرير لا تفعل. على الهاتف تُفتح القائمة بملء الشاشة. يزيل **مسح الكل** جميع علامات الاختيار دفعةً واحدة.
- **أنواع البطاقات** — يعرض زر المِصفاة كل نوع بطاقة على المخطط مع عدد بطاقاته. أزل التحديد عن نوع لإخراج بطاقاته، وكل علاقة تمسّها، من العرض — وهو مفيد حين تريد قراءة كيف تعتمد التطبيقات على مكوّنات تقنية المعلومات دون القدرات المرتبطة بها. تعرض شارة على الزر عدد الأنواع المخفية حاليًا، ويبقى النوع المخفي في القائمة حتى يمكن إعادته، ويعيد **إظهار الكل** كل شيء دفعة واحدة. تظل البطاقة الموجودة في المركز ظاهرة دائمًا مهما كان نوعها. وتُحفظ الاختيارات بين الزيارات.
- **إظهار شعارات البطاقات** — تعرض البطاقة التي لها شعار خاص بها ذلك الشعار في الزاوية العلوية اليسرى، مع أيقونة نوع البطاقة كشارة صغيرة فوقه، فيبقى كل من المنتج ونوع البطاقة واضحًا. مُفعَّل افتراضيًا؛ يمكن إيقافه من قائمة **خيارات العرض** للحصول على مخطط بلا زخرفة. أما البطاقات التي لا شعار لها — وكل بطاقات نوع أوقف المسؤول الشعارات فيه — فتبدو كما كانت في الحالتين. وتُضمَّن الشعارات في تصدير الصور.
...
- **تجميع العلاقات** — في مخطط مزدحم، قد تحجب كل وصلة مرسومة على حدة شكل المشهد العام. فعّل هذا الخيار من قائمة **خيارات العرض** لتجميع البطاقات المرتبطة في صناديق ورسم وصلة واحدة بين أي صندوقين، مع عدد العلاقات التي تمثّلها: يظهر العدد في شارة على الوصلة، وتُرسم الوصلة أسمك كلما زاد عدد العلاقات التي تحملها، فتقرأ ثقل الاعتماد بنظرة واحدة. اختر ما تمثّله الصناديق: **حسب الطبقة** أو **حسب نوع البطاقة** (صندوق لكل نوع، مثل *التطبيقات (8)*) أو **حسب النوع الفرعي**. تبقى العلاقات بين بطاقتين في الصندوق نفسه مرسومة داخله، وتبقى البطاقة الموجودة في المركز وحدها، فترى بنظرة واحدة علاقتها بكل جزء من المشهد. وأثناء تجميع العلاقات تُنحّى مسارات الطبقات الأربع جانبًا وتُوضع الصناديق بحسب ما تصله، فتبقى الوصلات قصيرة بدل أن تقطع ارتفاع المخطط كله؛ و**حسب الطبقة** يعيد إليك الطبقات. مرّر المؤشر فوق وصلة لعرض العلاقات التي جمعتها، أو فوق بطاقة لإبراز علاقاتها وحدها. ويمكن سحب الصناديق كما تُسحب مسارات الطبقات، وتتحرك بطاقاتها معها. ويعمل **إنشاء مخطط** على العرض المجمّع أيضًا، مع تنبيه يُعرض أولًا — انظر أدناه.
...
- **إنشاء مخطط** — حوِّل العرض الحالي إلى مخطط جديد قابل للتحرير في [وحدة المخططات](diagrams.md). تُعاد إنشاء البطاقات والعلاقات ومسارات طبقات البنية الأربع، ويظل كل شكل مرتبطًا ببطاقة المخزون الخاصة به. يُطلب منك اسم، ثم تُنقل مباشرة إلى المخطط الجديد. متاح للمستخدمين الذين يمكنهم إنشاء المخططات. ومن عرض فُعّل فيه **تجميع العلاقات** يصبح كل صندوق في المخطط حاوية بداخلها بطاقاته — وتبقى مرتبطة بالمخزون — بينما تُرسم الوصلات بين الصناديق كزخرفة تحمل أعداد اليوم: فهي لا تتبع المخزون، ولا يمكن مزامنتها، ولا تُعلَّم عند تغيّر العلاقات. ويوضّح ذلك مربع حوار قبل أن يُطلب منك الاسم.

![العلاقات مجمّعة حسب نوع البطاقة](../assets/img/ar/13c_dependencies_aggregate.png)
...
التكاليف سنوية، لذا يعرضها التقرير دائمًا لـ**سنة مالية واحدة** — وهي السنة الحالية عند فتحه. تُحتسب التكلفة السنوية للبطاقة **كاملةً** في كل سنة مالية بدءًا من السنة التي تصبح فيها **نشطة** وحتى السنة التي يقع فيها تاريخ **نهاية العمر** الخاص بها، مع احتساب السنتين كلتيهما. لا يُحتسب أي شيء بالتناسب: فالتطبيق الذي يُسحب من الخدمة في نوفمبر يحمل تكلفته السنوية كاملةً لتلك السنة، ولا شيء في السنة التالية. وعليه، لم تعد البطاقة التي وقع تاريخ نهاية عمرها في سنة مالية سابقة تُضاف إلى الإجمالي.

تُقرأ تواريخ دورة الحياة المفقودة كما في تقارير السفر عبر الزمن الأخرى:

- **لا يوجد تاريخ «نشط»، لكن يوجد تاريخ «تخطيط» أو «إدخال تدريجي»** — ما تزال البطاقة مخطَّطًا لها ولا تُحتسب في أي سنة.
- **لا يوجد تاريخ لنهاية العمر** — تُحتسب البطاقة في كل سنة بدءًا من السنة التي تصبح فيها نشطة.
- **لا توجد أي تواريخ لدورة الحياة** — تُحتسب البطاقة في كل سنة.

لعرض سنة أخرى، اسحب شريط التمرير **السفر عبر الزمن** في شريط الأدوات. لا يتوقف إلا عند السنوات المالية — فلا شيء بينها يمكن التوقف عنده — وتنتقل مفاتيح الأسهم سنة واحدة في كل مرة. يعرض المؤشر السنة المحددة (مثل *السنة المالية 2026*، أو *السنة المالية 2025–2026* حين لا تبدأ سنتك المالية في يناير)، ويعيدك **السنة المالية الحالية** إليها. يغطي شريط التمرير السنوات التي تشملها دورات حياة بطاقاتك، مضافًا إليها سنة واحدة من كل طرف.

تنطبق السنة المحددة على كل ما في الصفحة: الإجماليات، والخريطة الشجرية، والجدول، وتجميعات **مصدر التكلفة** (إذ يتوقف المكوّن التقني المسحوب من الخدمة عن الإضافة إلى إجمالي تطبيقه)، والتعمّق. تظهر في ترويسة الطباعة وتُحفظ مع التقرير: فالتقرير المحفوظ على السنة الحالية يُعاد فتحه على السنة التي تكون حالية آنذاك، والتقرير المحفوظ على سنة أخرى يُعاد فتحه على تلك السنة. يحدد المسؤول الشهر الذي تبدأ فيه السنة المالية ضمن [الإعدادات ← عام](../admin/settings.md).
...
يُحافَظ على السنة المالية، وتحديد مصدر التكلفة، وعوامل التصفية الأخرى أثناء التعمّق، ويُعدّ المستوى المتعمَّق فيه جزءًا من تهيئة التقرير المحفوظ — فحفظ تقرير أثناء التعمّق يعيد فتحه مباشرةً عند ذلك المستوى. ومع عدم وجود مصدر تكلفة نشط، يفتح النقر على مستطيل لوحة البطاقة الجانبية بدلاً من ذلك (إذ لا شيء يُفصَّل).
...
ويُختتم التقرير بمخطط **تغطية نهاية العمر**: كم من التطبيقات والمكوّنات التقنية لها نهاية عمر مرتبطة من endoflife.date، أو مُدخلة يدويًا، أو غير مسجَّلة إطلاقًا. انقر على أي جزء لسرد البطاقات التي يمثّلها؛ ومن لوحة **غير مسجَّلة**، يفتح زر **عرض في المخزون** تلك المكوّنات بعينها في [المخزون](inventory.md)، حيث يتيح لك مرشّح **نهاية العمر** معالجتها.
...
- **لا توجد بيانات نهاية عمر** — التطبيقات والمكوّنات التقنية التي لا ترتبط بـ endoflife.date ولا تحمل تاريخ نهاية عمر خاصًا بها. تُدرَج بالحالة **لا توجد بيانات نهاية عمر**؛ اضغط المربّع الذي يحمل الاسم نفسه لعرضها وحدها، واضغطه ثانيةً لإعادة البقية. ويُحتسب التاريخ الذي تصونه يدويًا في دورة الحياة كبيانات مسجَّلة، فلا يعود المكوّن الذي قيّمته من قبل للظهور هنا.
