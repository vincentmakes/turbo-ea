...
التكاليف سنوية، لذا يعرضها التقرير لـ**السنة المالية الحالية** — وتذكرها شارة في شريط الأدوات، مثل **السنة المالية 2026 (الحالية)** (أو *السنة المالية 2025–2026 (الحالية)* حين لا تبدأ سنتك المالية في يناير). تُحتسب التكلفة السنوية للبطاقة **كاملةً** حين تقع السنة المالية الحالية بين السنة التي تصبح فيها البطاقة **نشطة** والسنة التي يقع فيها تاريخ **نهاية العمر** الخاص بها، مع احتساب السنتين كلتيهما. لا يُحتسب أي شيء بالتناسب: فالتطبيق الذي يُسحب من الخدمة في نوفمبر يحمل تكلفته السنوية كاملةً هذا العام. ولا تُحتسب البطاقة التي وقع تاريخ نهاية عمرها في سنة مالية سابقة.

تُقرأ تواريخ دورة الحياة المفقودة كما في تقارير السفر عبر الزمن:

- **لا يوجد تاريخ «نشط»، لكن يوجد تاريخ «تخطيط» أو «إدخال تدريجي»** — ما تزال البطاقة مخطَّطًا لها ولا تُحتسب.
- **لا يوجد تاريخ لنهاية العمر** — تُحتسب البطاقة بدءًا من السنة التي تصبح فيها نشطة.
- **لا توجد أي تواريخ لدورة الحياة** — تُحتسب البطاقة.

تنطبق القاعدة على كل ما في الصفحة — الإجماليات، والخريطة الشجرية، والجدول، وتجميعات **مصدر التكلفة** (إذ يتوقف المكوّن التقني المسحوب من الخدمة عن الإضافة إلى إجمالي تطبيقه)، والتعمّق — وتظهر السنة المالية في ترويسة الطباعة. لا يوجد اختيار لسنوات أخرى: فللبطاقة رقم سنوي واحد، والتكاليف الفعلية تتغيّر من سنة إلى أخرى، لذا فإن عرض الرقم نفسه لسنة أخرى سيكون مضلِّلًا. يحدد المسؤول الشهر الذي تبدأ فيه السنة المالية ضمن [الإعدادات ← عام](../admin/settings.md).
...
يُحافَظ على تحديد مصدر التكلفة وعوامل التصفية الأخرى أثناء التعمّق، ويُعدّ المستوى المتعمَّق فيه جزءًا من تهيئة التقرير المحفوظ — فحفظ تقرير أثناء التعمّق يعيد فتحه مباشرةً عند ذلك المستوى. ومع عدم وجود مصدر تكلفة نشط، يفتح النقر على مستطيل لوحة البطاقة الجانبية بدلاً من ذلك (إذ لا شيء يُفصَّل).
