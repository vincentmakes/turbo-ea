...
- **Ajouter une relation** -- Cliquez sur **+** pour créer une nouvelle relation ; le sélecteur liste les cartes correspondantes dès son ouverture (les meilleures correspondances de votre saisie apparaissent en premier, d'autres se chargent au défilement). Les cartes déjà liées sont masquées, avec une légende indiquant leur nombre. Le sélecteur reste ouvert après chaque choix, ce qui permet d'ajouter plusieurs relations à la suite, et chaque carte ajoutée apparaît sous forme de puce juste au-dessus du champ de recherche -- cliquez sur le **×** d'une puce pour annuler cet ajout. **Terminé** ferme la ligne
