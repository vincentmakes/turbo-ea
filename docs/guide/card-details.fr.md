...
- **Ajouter une relation** -- Cliquez sur **+** pour ouvrir la boîte de dialogue **Ajouter des relations**. Elle liste les fiches correspondantes au fil de la saisie (les meilleures correspondances d'abord, d'autres se chargent au défilement) et masque celles déjà liées, avec une légende indiquant leur nombre. Cliquer sur une fiche la lie aussitôt et elle apparaît sous forme de puce en haut -- cliquez sur le **×** d'une puce pour annuler cet ajout. La boîte de dialogue reste ouverte pour en ajouter autant que vous voulez, et le sélecteur **Type de relation** en haut permet de changer de type sans la fermer. Sur téléphone, elle s'ouvre en plein écran
