...
- **链接** —— 输入或粘贴的网址会在输入时自动变成链接，文档中的每个链接都会在新标签页中打开。在支持链接之前撰写的文档中的网址会在显示时转换为链接
...
- **架构决策** —— ADR 不再在此处列出。现在每张卡片都有独立的 **架构决策** 标签页；有关它显示的内容以及如何从卡片关联、创建或取消关联决策，请参见[卡片详情](card-details.md)。
