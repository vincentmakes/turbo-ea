...
![可用报告菜单](../assets/img/en/09_reports_menu.png)

## 投资组合报告

![投资组合报告](../assets/img/en/10_report_portfolio.png)
...
![业务能力地图](../assets/img/en/11_capability_map.png)
...
![生命周期报告](../assets/img/en/12_lifecycle.png)
...
![依赖关系报告](../assets/img/en/13_dependencies.png)
...
![成本报告](../assets/img/en/34_report_cost.png)
...
![矩阵报告](../assets/img/en/35_report_matrix.png)
...
![数据质量报告](../assets/img/en/33_report_data_quality.png)
...
![生命周期终止报告](../assets/img/en/32_report_eol.png)
...
![已保存报告库](../assets/img/en/36_saved_reports.png)
