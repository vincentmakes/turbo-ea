...
- **Voyage dans le temps** -- Déplacez le curseur de la frise chronologique pour voir le paysage tel qu'il se présente à une date donnée. Les fiches qui n'ont pas encore démarré sont masquées. En regardant vers l'avenir, les fiches qui **arrivent** entre-temps sont encadrées en pointillés et marquées *PRÉVU*, tandis que les fiches **retirées** restent affichées, estompées et marquées *RETIRÉ* — une transformation planifiée montre ainsi ce qu'elle supprime autant que ce qu'elle laisse. L'interrupteur **Afficher les fiches retirées**, dans la barre d'outils, les masque pour ne laisser que l'état final. La frise est jalonnée de chaque date d'arrivée ou de retrait des fiches du diagramme affiché ; cliquez sur un repère pour amener le curseur directement sur ce changement. Le curseur s'applique à toutes les vues et la date est enregistrée avec le rapport.
