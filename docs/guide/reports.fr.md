...
- **Voyage dans le temps** -- Déplacez le curseur de la frise chronologique pour voir le paysage tel qu'il se présente à une date donnée. Les fiches qui n'ont pas encore démarré sont masquées, et celles retirées à cette date disparaissent avec leurs relations. En regardant vers l'avenir, les fiches qui **arrivent** entre-temps sont encadrées en pointillés et marquées *PRÉVU*, et celles qui **sortent** sont marquées *RETIRÉ* — une transformation planifiée se lit ainsi directement sur le diagramme. Activez **Afficher les fiches en fin de vie** pour conserver les fiches retirées sur le canevas. Le curseur s'applique à toutes les vues et la date est enregistrée avec le rapport.
