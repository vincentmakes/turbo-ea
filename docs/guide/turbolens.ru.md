...
!!! note
    TurboLens требует настройки коммерческого AI-провайдера (Anthropic Claude, OpenAI, DeepSeek, Google Gemini или Amazon Bedrock) в разделе [Настройки AI](../admin/ai.md). Модуль становится доступен автоматически после настройки AI.

## Панель управления

![Панель управления TurboLens](../assets/img/ru/75_turbolens_panel_upravleniya.png)
...
![Мастер «Архитектурный ИИ», шаг 1](../assets/img/ru/76_turbolens_arkhitektor.png)
...
| **Dependency Diagram** | Интерактивная [Layered Dependency View](reports.md#layered-dependency-view) (многослойное представление зависимостей), показывающая существующие узлы наряду с предлагаемыми (пунктирные границы с зелёной меткой «NEW»). Перемещайте, масштабируйте и исследуйте архитектуру визуально |
...
Сканер соответствия — это анализ TurboLens, который производит находки соответствия по включённым регламентам. Находки, жизненный цикл, путь ручного создания, рабочий процесс продвижения в Риск и пакетные действия — всё это документировано в выделенном [**руководстве по Соответствию**](compliance.md) — только сама кнопка запуска сканирования живёт за флагом TurboLens.

Находки соответствия также могут быть **созданы вручную** без настроенного AI-провайдера, поэтому вкладка Соответствие работает в развёртываниях без настроенного LLM.

## История анализа

![История анализов TurboLens](../assets/img/ru/77_turbolens_istoriya.png)
