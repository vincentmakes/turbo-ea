...
| **Actividad de llamada** | Una tarea BPMN con borde grueso que invoca un proceso definido de forma independiente. En Turbo EA se vincula a la ficha de Proceso de negocio que invoca — elegida en el modelador, el panel de propiedades o la tabla de pasos — y publicar el flujo crea una relación *invoca* entre los dos procesos |
