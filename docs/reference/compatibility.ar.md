...
مقارنة بسلسلة `0.x`، فإن `1.0.0` نفسه ليس إصدار ميزات — إنه النقطة التي تبدأ عندها الالتزامات أعلاه بالتطبيق. الشيفرة المشحونة في `1.0.0` هي نفس الشيفرة التي شُحِنت في `0.71.0`، بالإضافة إلى تصليب سلسلة التوريد وتغييرات تدفق المساهمين الموثّقة في [إدخال CHANGELOG لـ `1.0.0`](https://github.com/TurboEA/turbo-ea/blob/main/CHANGELOG.md#100---2026-05-05).
