...
| **Aufrufaktivität** | Eine BPMN-Aufgabe mit dickem Rand, die einen eigenständig definierten Prozess aufruft. In Turbo EA wird sie mit der Geschäftsprozess-Karte verknüpft, die sie aufruft — ausgewählt im Modellierer, im Eigenschaftenpanel oder in der Schritttabelle —, und beim Veröffentlichen des Ablaufs entsteht eine *ruft auf*-Beziehung zwischen den beiden Prozessen |
