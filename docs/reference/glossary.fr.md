...
| **Activité d'appel** | Une tâche BPMN au bord épais qui invoque un processus défini de façon autonome. Dans Turbo EA, elle est liée à la fiche Processus métier qu'elle appelle -- choisie dans le modélisateur, le panneau des propriétés ou le tableau des étapes -- et la publication du flux crée une relation *appelle* entre les deux processus |
