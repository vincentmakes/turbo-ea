...
![Расширения — вкладка «Установленные» с идентификатором экземпляра](../assets/img/ru/93a_admin_rasshireniya_ustanovlennye.png)
...
![Расширения — вкладка «Магазин»](../assets/img/ru/93_admin_rasshireniya_magazin.png)
