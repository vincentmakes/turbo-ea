...
- `core.todos.read` / `core.todos.write` — чтение или изменение задач через SDK расширений. Право записи включает чтение. Расширение синхронизации никогда не может затронуть системные задачи (например, запросы на подпись) или задачи, принадлежащие другому расширению.
