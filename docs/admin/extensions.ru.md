...
2. Откройте **Админ → Расширения**, нажмите **Установить из файла…** в верхней части страницы (рядом с ID экземпляра — кнопка есть на обеих вкладках) и загрузите полученный файл `.teax`.
