...
Большинство расширений работают только со своими данными. Расширение, интегрирующееся с данными ядра — например, коннектор, синхронизирующий задачи (todo) с внешним трекером задач, таким как Jira или MS Planner ([#921](https://github.com/TurboEA/turbo-ea/discussions/921)) — должно объявить **гранты** в своём подписанном манифесте:
