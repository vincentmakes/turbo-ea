...
Вкладка **Магазин** работает без какой-либо настройки и показывает опубликованные поставщиком расширения сеткой компактных плиток — логотип, название, состояние лицензии и цена. Щёлкните плитку, чтобы открыть справа панель с полным описанием, снимками экрана, тегами категорий и сведениями об источнике и лицензии. Расширения без изображения получают сгенерированную плитку с инициалами.
