...
| Upload massimo (l'importazione dell'area di lavoro arriva a 2 GB) | Non documentato da Microsoft: provate un'importazione da 2 GB prima di farci affidamento | **32 MiB per richiesta su HTTP/1** | Nessun limite di piattaforma |
