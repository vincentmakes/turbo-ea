...
| Plus gros envoi (l'import d'espace de travail va jusqu'à 512 Mo) | Non documenté par Microsoft — testez un import de 512 Mo avant de compter dessus | **32 Mio par requête en HTTP/1** | Aucune limite de plateforme |
