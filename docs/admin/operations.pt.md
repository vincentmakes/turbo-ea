...
No Kubernetes, o [chart Helm](kubernetes.md) usa esse mesmo banco gerenciado como único banco de dados suportado — ele nunca executa o PostgreSQL dentro do cluster.
