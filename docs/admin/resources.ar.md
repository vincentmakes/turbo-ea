...
|-------|-------------|----------|
| **ملف** | ملف مرفوع إلى بطاقة (PDF، DOCX، XLSX، PPTX، DOC، XLS، PPT، ODT، ODS، ODP، ODG، ZIP، GZ، TAR، 7Z، MSG، EML، PNG، JPG، GIF، WEBP، SVG، TXT، CSV، MD، JSON، XML) | نوع الملف، الحجم، فئة الملف |
