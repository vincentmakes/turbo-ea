...
على Kubernetes، يستخدم [مخطط Helm](kubernetes.md) قاعدة البيانات المُدارة نفسها بوصفها قاعدة البيانات الوحيدة المدعومة — فهو لا يشغّل PostgreSQL داخل العنقود أبدًا.
