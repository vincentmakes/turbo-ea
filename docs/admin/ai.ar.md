...
يتيح البحث الدلالي للمستخدمين العثور على البطاقات حسب **المعنى** بدلًا من الصياغة الحرفية — فالبحث عن «أنظمة الدفع الموجَّهة للعملاء» يُظهِر بطاقة باسم «NexaPay Gateway» قد يفوتها البحث النصّي البسيط. وهو يشغّل أداة MCP المسمّاة `semantic_search_cards`.
