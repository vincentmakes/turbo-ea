...
| Größter Upload (Workspace-Import bis 2 GB) | Von Microsoft nicht dokumentiert — einen 2-GB-Import testen, bevor man sich darauf verlässt | **32 MiB je Anfrage über HTTP/1** | Kein Plattformlimit |
