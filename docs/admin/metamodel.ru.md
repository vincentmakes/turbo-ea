...
Подтипы обеспечивают вторичную классификацию внутри типа. Например, тип «Приложение» имеет подтипы: Бизнес-приложение, Микросервис, ИИ-агент и Развёртывание. Каждый подтип может иметь переведённые названия.
