...
- **Данные модулей** — BPM (диаграммы процессов, элементы, версии потоков, оценки), PPM (отчёты о статусе, затраты, бюджеты, риски, задачи, WBS, зависимости), реестр рисков GRC (риски, задачи по снижению рисков и их экземпляры, связи с картами), архитектурные решения и Statements of Architecture Work, свободные диаграммы, сохранённые отчёты, закладки, веб-порталы и опросы.
