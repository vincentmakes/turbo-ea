...
Le tableau porte toujours sur les fiches **Initiative** ; le sélecteur de type de fiche
...
regroupement par n'importe quel type de fiche lié, et l'aperçu du rapport d'avancement
...
!!! note
    ...
    coût stockés sur la fiche Initiative elle-même, les adresses e-mail des utilisateurs,
...
Le portail est toujours limité aux fiches **Processus métier**, le sélecteur de
type de fiche est donc verrouillé. Les filtres **sous-types** et **étiquettes**
