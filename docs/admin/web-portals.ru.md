...
!!! note
    **Войти через SSO** можно выбрать только после настройки единого входа. Зарегистрируйте `https://ваш-домен-turbo-ea/portal/sso-callback` как разрешённый URI перенаправления у вашего поставщика удостоверений. Отмена публикации портала мгновенно отзывает доступ во всех режимах.
