...
|-----|----------------|----------|
| **Файл** | Файл, загруженный в карточку (PDF, DOCX, XLSX, PPTX, DOC, XLS, PPT, ODT, ODS, ODP, ODG, ZIP, GZ, TAR, 7Z, MSG, EML, PNG, JPG, GIF, WEBP, SVG, TXT, CSV, MD, JSON, XML) | Тип файла, размер, категорию файла |
