...
!!! note
    لا يمكن اختيار **تسجيل الدخول عبر SSO** إلا بعد تهيئة الدخول الموحّد. سجّل `https://نطاق-turbo-ea-الخاص-بك/portal/sso-callback` كعنوان URI لإعادة توجيه مسموح به لدى موفّر الهوية. يؤدي إلغاء نشر البوابة إلى إبطال الوصول فورًا في جميع الأوضاع.
