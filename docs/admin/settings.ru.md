...
|---------|-----|---------------|--------------------|
| **Общие** | `/admin/settings?tab=general` | Внешний вид (логотип, favicon, валюта, формат даты, включённые языки, финансовый год), e-mail SMTP, **переключатели модулей** (BPM, PPM, GRC, TurboLens) | Эта страница |
