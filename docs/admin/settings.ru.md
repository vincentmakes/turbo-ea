...
Включайте или отключайте языки, доступные пользователям в селекторе языка. Все семь поддерживаемых локалей могут быть включены или отключены индивидуально:
