...
![إدارة المستخدمين والأدوار](../assets/img/ar/21_admin_users.png)
...
2. عبّئ النموذج:
   ...
   - **Password** (اختياري): اتركه فارغًا ليختار المستخدم كلمة مروره الخاصة عند أول تسجيل دخول. إن كان SSO مُفعّلًا، يمكن للمستخدم بلا كلمة مرور تسجيل الدخول عبر مزوّد SSO لديه بدلًا من ذلك
...
- إن لم تُضبط كلمة مرور (حساب «Pending Setup»)، يُولَّد رمز إعداد كلمة مرور لمرة واحدة. إن فعّلت «إرسال بريد الدعوة»، يُرسَل كرابط لتعيين كلمة المرور؛ وإلا يضبط المستخدم كلمة مروره عند أول تسجيل دخول عبر خيار «نسيت كلمة المرور» في صفحة تسجيل الدخول — وهو ما يعمل حتى لو لم يكن لديه كلمة مرور قط
...
!!! note "لا يمكنك خفض دورك أو إلغاء تنشيط نفسك"
    في صفّك أنت، تكون قائمة **الدور** المنسدلة وزر **إلغاء التنشيط** معطَّلين، كما ترفض واجهة البرمجة كلا التغييرين أيضًا. فالمسؤول الذي يتخلّى عن دوره يفقد شاشات الإدارة بالنقرة نفسها، ولا يستطيع إعادتها إليه سوى مسؤول آخر. ولتسليم المهام، اطلب من مسؤول ثانٍ أن يغيّر دورك نيابةً عنك. وإن لم يعد بإمكان أحد تسجيل الدخول بصفة مسؤول، فاتبع [استعادة وصول المسؤول](operations.md#recovering-administrator-access).
...
تنطبق حماية "آخر مسؤول": تُرفض تغييرات الأدوار بالجملة التي قد تترك صفر مسؤولين نشطين، وينطبق الأمر نفسه على تعطيل أو حذف آخر مسؤول. وللسبب نفسه يُتخطّى حسابك الخاص في تغييرات الأدوار بالجملة وفي إلغاء التنشيط بالجملة.
...
![إدارة الأدوار والأذونات](../assets/img/ar/39_admin_roles.png)
...
تنطبق الأذونات على شريط العنوان كما تنطبق على القائمة. الصفحة التي لا يستطيع الدور فتحها تعرض إشعار **تم رفض الوصول** مع رابط للعودة إلى لوحة المعلومات، سواء تم الوصول إليها من التنقل أو من إشارة مرجعية أو من رابط شاركه شخص آخر — لذا فإن إخفاء عنصر القائمة وحجب الصفحة هما دائمًا القرار نفسه.
تنطبق أذونات الدور افتراضيًا على كل أنواع البطاقات. ويمكن للمسؤول تضييقها لكل نوع بطاقة على حدة — بالسماح أو المنع لـ**الإنشاء** و**التعديل** و**الأرشفة** و**الحذف** — من علامة التبويب **الأذونات** الخاصة بنوع البطاقة في [النموذج الفوقي](metamodel.md#permissions).
