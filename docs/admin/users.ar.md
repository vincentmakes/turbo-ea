...
- إن لم تُضبط كلمة مرور (حساب «Pending Setup»)، يُولَّد رمز إعداد كلمة مرور لمرة واحدة. يضبط المستخدم كلمة مروره بنفسه عند أول تسجيل دخول عبر الرابط — يُرسَل ببريد الدعوة إن فعّلت الخانة، أو عبر الرابط القابل للنسخ الذي يظهر بعد الإنشاء. ويمكنه أيضًا الوصول إليه من خيار «نسيت كلمة المرور» في صفحة تسجيل الدخول، رغم أنه لم يكن لديه كلمة مرور قط
