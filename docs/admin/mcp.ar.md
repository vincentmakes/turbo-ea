...
يعرض الخادم 18 أداة كتابة، كل منها موسومة بأنها **إضافية** (تنشئ البيانات أو توسّعها) أو **هدّامة** (تعدّل البيانات القائمة أو تزيلها) حتى تتمكّن الموصّلات من التحذير وفقًا لذلك.
