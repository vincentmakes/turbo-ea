...
يعرض الخادم 31 أداة قراءة موزّعة على ثماني مجموعات.
...
| `semantic_search_cards` | بحث في البطاقات قائم على المعنى (تضمين) مدموج مع مطابقة السلسلة الجزئية؛ نتائج مرتَّبة مع score/match/مقتطف. يتطلّب مزوّد تضمين (وإلا العودة إلى السلسلة الجزئية) |
