...
!!! tip "Запуск в Kubernetes?"
    [Helm-чарт](../admin/kubernetes.md) устанавливает Turbo EA в EKS, AKS, GKE или любом другом кластере с именно таким внешним PostgreSQL; на той же странице разобрано каждое облако.
