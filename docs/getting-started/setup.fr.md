...
Le guide complet du développeur — nommage des branches, commandes de lint et de test, vérifications pre-commit — est dans [CONTRIBUTING.md](https://github.com/TurboEA/turbo-ea/blob/main/CONTRIBUTING.md).
