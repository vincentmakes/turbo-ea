...
If this is your first time accessing the platform, you can register by clicking "Sign Up". Administrators can also invite users from the administration panel (see [Users & Roles](../admin/users.md)).
