...
export const DOC_PAGES: PageDef[] = [
  ...
  // ── ArchLens AI ──────────────────────────────────────────────────────────
  {
    id: "48_archlens_dashboard",
    route: "/archlens",
    waitFor: ".MuiPaper-root",
    actions: [{ type: "wait", ms: 800 }],
    filenames: {
      en: "48_archlens_dashboard",
      de: "48_archlens_uebersicht",
      fr: "48_archlens_tableau_bord",
      es: "48_archlens_panel",
      it: "48_archlens_panoramica",
      pt: "48_archlens_painel",
      zh: "48_archlens_仪表板",
      ru: "48_archlens_обзор",
    },
  },
  {
    id: "49_archlens_vendors",
    route: "/archlens?tab=vendors",
    waitFor: ".MuiPaper-root",
    actions: [{ type: "wait", ms: 800 }],
    filenames: {
      en: "49_archlens_vendors",
      de: "49_archlens_hersteller",
      fr: "49_archlens_fournisseurs",
      es: "49_archlens_proveedores",
      it: "49_archlens_fornitori",
      pt: "49_archlens_fornecedores",
      zh: "49_archlens_供应商",
      ru: "49_archlens_поставщики",
    },
  },
  {
    id: "50_archlens_resolution",
    route: "/archlens?tab=resolution",
    waitFor: ".MuiPaper-root",
    actions: [{ type: "wait", ms: 800 }],
    filenames: {
      en: "50_archlens_resolution",
      de: "50_archlens_aufloesung",
      fr: "50_archlens_resolution",
      es: "50_archlens_resolucion",
      it: "50_archlens_risoluzione",
      pt: "50_archlens_resolucao",
      zh: "50_archlens_解析",
      ru: "50_archlens_разрешение",
    },
  },
  {
    id: "51_archlens_duplicates",
    route: "/archlens?tab=duplicates",
    waitFor: ".MuiPaper-root",
    actions: [{ type: "wait", ms: 800 }],
    filenames: {
      en: "51_archlens_duplicates",
      de: "51_archlens_duplikate",
      fr: "51_archlens_doublons",
      es: "51_archlens_duplicados",
      it: "51_archlens_duplicati",
      pt: "51_archlens_duplicados",
      zh: "51_archlens_重复项",
      ru: "51_archlens_дубликаты",
    },
  },
  {
    id: "52_archlens_architect",
    route: "/archlens?tab=architect",
    waitFor: ".MuiPaper-root",
    actions: [{ type: "wait", ms: 800 }],
    filenames: {
      en: "52_archlens_architect",
      de: "52_archlens_architekt",
      fr: "52_archlens_architecte",
      es: "52_archlens_arquitecto",
      it: "52_archlens_architetto",
      pt: "52_archlens_arquiteto",
      zh: "52_archlens_架构师",
      ru: "52_archlens_архитектор",
    },
  },
  {
    id: "53_archlens_history",
    route: "/archlens?tab=history",
    waitFor: ".MuiPaper-root",
    actions: [{ type: "wait", ms: 600 }],
    filenames: {
      en: "53_archlens_history",
      de: "53_archlens_verlauf",
      fr: "53_archlens_historique",
      es: "53_archlens_historial",
      it: "53_archlens_cronologia",
      pt: "53_archlens_historico",
      zh: "53_archlens_历史",
      ru: "53_archlens_история",
    },
  },
];
