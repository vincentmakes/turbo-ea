...
RELATIONS = [
    ...
    _rel("relITCToTechCat", "itc_postgres", "tc_rdbms"),
    _rel("relITCToTechCat", "itc_azure_sql", "tc_rdbms"),
    _rel("relITCToTechCat", "itc_redis", "tc_databases"),
    _rel("relITCToTechCat", "itc_azure_eh", "tc_msg_broker"),
    _rel("relITCToTechCat", "itc_nginx", "tc_api_gw"),
    _rel("relITCToTechCat", "itc_aks", "tc_container_orch"),
    _rel("relITCToTechCat", "itc_azure_vm", "tc_compute"),
    _rel("relITCToTechCat", "itc_aws_ec2", "tc_compute"),
    _rel("relITCToTechCat", "itc_fortinet", "tc_netsec"),
    _rel("relITCToTechCat", "itc_azure_devops", "tc_cicd"),
    _rel("relITCToTechCat", "itc_github", "tc_cicd"),
