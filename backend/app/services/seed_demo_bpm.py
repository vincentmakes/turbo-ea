...
PROCESSES = [
    ...
    _fs(
        "bp_strategic_planning",
        "Strategic Planning & Review",
        parent="bp_cat_management",
        subtype="process",
    ...
    _fs(
        "bp_otc_consumer",
        "Order to Cash (Consumer/Smart Home)",
        parent="bp_grp_otc",
        subtype="variant",
...
_BPM_RELATION_SPECS = [
    ...
    (
        ...
        "bp_order_entry",
        "SAP S/4HANA",
        {"usageType": "orchestrates", "criticality": "critical"},
    ),
    (
        "relProcessToApp",
        "bp_order_entry",
        "Salesforce Sales Cloud",
        {"usageType": "creates", "criticality": "high"},
    ),
    (
        "relProcessToApp",
        "bp_credit_check",
        "SAP S/4HANA",
        {"usageType": "reads", "criticality": "critical"},
    ),
    (
        "relProcessToApp",
        "bp_fulfillment",
        "SAP S/4HANA",
        {"usageType": "updates", "criticality": "critical"},
    ),
    (
        "relProcessToApp",
        "bp_fulfillment",
        "Siemens Opcenter",
        {"usageType": "reads", "criticality": "high"},
    ),
    (
        "relProcessToApp",
        "bp_invoicing",
        "SAP S/4HANA",
        {"usageType": "creates", "criticality": "critical"},
    ),
    ...
    (
        ...
        "bp_proto_validation",
        "MATLAB/Simulink",
        {"usageType": "orchestrates", "criticality": "high"},
    ),
    (
        "relProcessToApp",
        "bp_proto_validation",
    ...
    (
        ...
        "bp_quality_inspection",
        "Siemens Opcenter",
        {"usageType": "updates", "criticality": "high"},
    ),
    (
        "relProcessToApp",
        "bp_incident_mgmt",
    ...
    (
        ...
        "bp_warranty_claim",
        "SAP S/4HANA",
        {"usageType": "updates", "criticality": "medium"},
    ),
    (
        "relProcessToApp",
        "bp_requisition",
    ...
    (
        ...
        "bp_invoice_verification",
        "Coupa",
        {"usageType": "reads", "criticality": "medium"},
    ),
    (
        "relProcessToApp",
        "bp_recruitment",
    ...
    (
        ...
        "bp_onboarding",
        "ServiceNow",
        {"usageType": "creates", "criticality": "medium"},
    ),
    (
        "relProcessToApp",
        "bp_it_incident",
...
_ASSESSMENT_SPECS = [
    ...
    (
        ...
        5,
        3,
        "OTC well-optimized. Automation gap in shipping notifications.",
    ),
    (
        "bp_grp_otc",
        "2025-01-20",
        ...
        5,
        4,
        "Salesforce integration improved order tracking. Automation improved.",
    ),
    (
        "bp_grp_npi",
        "2024-06-15",
        ...
        4,
        1,
        "Gate process solid but heavily manual. Digitize design reviews.",
    ),
    (
        "bp_grp_npi",
        "2025-01-20",
        ...
        4,
        2,
        "Teamcenter integration improved traceability. Still manual gates.",
    ),
    ...
    (
        ...
        4,
        3,
        "Opcenter APS improved scheduling. SCADA still legacy.",
    ),
    (
        "bp_grp_service",
        "2024-06-15",
        ...
        3,
        2,
        "Field service dispatch still phone-based. Need mobile app.",
    ),
    (
        "bp_grp_service",
        "2025-01-20",
        ...
        3,
        2,
        "Service Cloud deployed. Field dispatch still not automated.",
    ),
    (
        "bp_grp_p2p",
        "2024-06-15",
        ...
        5,
        4,
        "P2P highly automated via SAP + Ariba. Minor manual exceptions.",
    ),
    (
        "bp_grp_p2p",
        "2025-01-20",
        ...
        5,
        4,
        "Three-way match fully automated. Best-in-class process.",
    ),
    (
        "bp_grp_iot",
        "2024-06-15",
        ...
        3,
        3,
        "Provisioning automated but anomaly detection immature.",
    ),
    (
        "bp_grp_iot",
        "2025-01-20",
        ...
        3,
        3,
        "Anomaly ML model v2 deployed. Still tuning false positive rate.",
    ),
    (
        "bp_ecm",
        "2024-06-15",
        ...
        5,
        3,
        "ECM well-controlled via Teamcenter. Cross-system sync needs work.",
    ),
    ...
    (
        ...
        3,
        3,
        "ServiceNow operational. Change management needs more rigor.",
    ),
    (
        "bp_grp_itsm",
        "2025-01-20",
        ...
        4,
        3,
        "Added CAB review workflow. Improved change success rate.",
    ),
]
...
async def seed_bpm_demo_data(db: AsyncSession) -> dict:
    ...
    for spec in _BPM_RELATION_SPECS:
        ...
        if tgt_ref_or_name.startswith("bp_"):
            ...
            tgt_id = (
                name_type_to_id.get((tgt_ref_or_name, expected_type)) if expected_type else None
