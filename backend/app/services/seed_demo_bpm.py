...
_BPM_RELATION_SPECS = [
    ...
    ("relProcessToApp", "bp_concept", "Confluence", {"usageType": "creates"}),
    ("relProcessToApp", "bp_concept", "Jira", {"usageType": "creates"}),
    (
        "relProcessToApp",
        "bp_design_review",
        "Siemens Teamcenter",
    ...
    ("relProcessToApp", "bp_it_incident", "Splunk", {"usageType": "reads"}),
    (
        "relProcessToApp",
        "bp_change_mgmt",
        "ServiceNow",
    ...
    ("relProcessToApp", "bp_ecm", "SAP S/4HANA", {"usageType": "updates"}),
    (
        "relProcessToApp",
        "bp_device_provisioning",
