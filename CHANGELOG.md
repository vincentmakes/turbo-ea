...
- Dependencies report: a transition mark that merges several nearby dates is now tinted purple and names the span it covers ("1 Apr 2027 – 1 Jul 2027") instead of looking and reading like a single-date mark, so a change absorbed into a crowded mark can be found rather than appearing unmarked.
