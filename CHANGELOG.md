...
### Added
- **Admin → Extensions** now notes that extensions are built and signed by Turbo EA (not self-built or third-party) and links to consulting for a tailored build.
