...
- **The sign-in card is now vertically centred.** The login card sits at the true vertical centre of the screen with the logo above it, instead of the logo+card group being centred as a whole (which left the card sitting slightly low).
