 ...
 * Tabs: Capability×Process Matrix, Process×App Matrix, Dependencies, Element-App Map
 */
...
export default function BpmReportPage() {
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 } }}>
      ...
      {tab === 0 && <CapabilityProcessMatrix />}
      {tab === 1 && <ProcessAppMatrix />}
      {tab === 2 && <ProcessDependencies />}
      {tab === 3 && <ElementAppMap />}
    </Box>
  );
}
