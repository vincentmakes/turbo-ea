...
vi.mock("ag-grid-react", () => ({
  AgGridReact: vi.fn((props: { columnDefs: ColDef[]; defaultColDef?: ColDef }) => {
...
describe("AdrGrid per-column filters", () => {
  ...
  it("keeps the checkbox selection column filter-free", () => {
    renderGrid();
    const col = capturedColumnDefs.find((c) => c.colId === "__select");
