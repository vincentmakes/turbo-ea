...
| `MCP_WRITES_ENABLED` | `true` | (MCP server) Kill switch for all 18 write tools — set to `false` to put the MCP server into read-only mode without a code redeploy. Read tools keep working. |
